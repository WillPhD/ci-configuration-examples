[![MATLAB](https://github.com/WillPhD/ci-configuration-examples/actions/workflows/ci.yml/badge.svg)](https://github.com/WillPhD/ci-configuration-examples/actions/workflows/ci.yml)
